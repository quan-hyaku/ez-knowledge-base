    ...
    <div class="container mx-auto px-6 text-center">
        ...
        <div class="max-w-3xl mx-auto relative group">
            ...
            <form action="{{ route('kb.search') }}" method="GET" class="flex">
                <input class="flex-1 pl-14 pr-4 py-5 bg-white dark:bg-slate-800 border-none rounded-l-xl search-shadow focus:ring-2 focus:ring-primary/20 text-slate-900 dark:text-white transition-all outline-none" placeholder="{{ config('kb.search.hero_placeholder') }}" type="text" name="q" required />
